...
from .scripts.data_generation.generate_qa_pairs import generate_qa_pairs
...
def prepare_ecoqa_data(force_regenerate: bool = False):
    if force_regenerate or not (TRAIN_QUESTIONS_PATH.exists() and VAL_QUESTIONS_PATH.exists() and TEST_QUESTIONS_PATH.exists()):
        print("Generating EcoQA QA pairs...")
        generate_qa_pairs()
    ...
    def preprocess_fn(example):
        return {
            ...
            "ground_truth_sql": example.get("ground_truth_sql", ""),
